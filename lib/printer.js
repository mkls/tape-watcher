...
module.exports = function (logger) {
    ...
    var encodeValue = function encodeValue(value) {
        ...
        if (typeof value === 'string') {
            ...
            var inspectResult = inspect(value, inspectOptions);
    ...
    var coloredDiff = function coloredDiff(actual, expected) {
        var addedColor = options.inverseDiffColors ? chalk.green : chalk.black.bgGreen;
        var removedColor = options.inverseDiffColors ? chalk.red : chalk.black.bgRed;
